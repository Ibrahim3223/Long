...
Key Features:
- Emotion detection from text (16 emotion types)
...
# ============================================================================
# EMOTIONAL ARC TEMPLATES (Optimized for Long-form)
# ============================================================================
...
EMOTIONAL_ARCS = {
    "rising_tension": {
        ...
        "pacing": "accelerating",
        "best_for": ["education", "educational", "entertainment", "tech", "documentary"],
    ...
    "problem_solution": {
        ...
        "pacing": "steady",
        "best_for": ["howto", "lifestyle", "education", "educational"],
    ...
    "curiosity_payoff": {
        ...
        "pacing": "controlled",
        "best_for": ["education", "educational", "tech", "science", "documentary"],
    ...
    "inspiration_journey": {
        ...
        "pacing": "building",
        "best_for": ["inspiration", "sports", "lifestyle", "storytelling"],
        "engagement_score": 0.83
    },

    "documentary_arc": {
        "description": "Deep dive with multiple revelations",
        "pattern": ["curiosity", "surprise", "awe", "validation"],
        "pacing": "layered",
        "best_for": ["documentary", "education", "educational", "history"],
        "engagement_score": 0.88
    },

    "storytelling_arc": {
        "description": "Classic narrative with emotional peaks",
        "pattern": ["curiosity", "anticipation", "fear", "joy", "validation"],
        "pacing": "narrative",
        "best_for": ["storytelling", "documentary", "entertainment"],
...
class EmotionAnalyzer:
    ...
    def suggest_emotional_arc(
        self,
        content_type: str,
        duration: int = 360  # Default 6 min for long-form
    ) -> Dict:
        """
        ...
        if not suitable_arcs:
            # Default to curiosity payoff for long-form
            suitable_arcs = [("curiosity_payoff", EMOTIONAL_ARCS["curiosity_payoff"])]

        # For long-form, prefer arcs with more emotional layers
        if duration > 180:  # More than 3 minutes
            # Prefer documentary or storytelling arcs
            long_form_arcs = [
                (name, arc) for name, arc in suitable_arcs
                if name in ["documentary_arc", "storytelling_arc", "rising_tension"]
            ]
            if long_form_arcs:
                suitable_arcs = long_form_arcs
    ...
    def generate_emotion_triggers(
        ...
        content_type: str,
        num_triggers: int = 5  # More triggers for long-form
    ) -> List[EmotionTrigger]:
        """
        ...
        # For long-form, distribute triggers across video
        placements = ["hook", "early", "middle", "late", "cta"]
        intensities = [
    ...
    def optimize_emotional_pacing(
        self,
        sentences: List[str],
        target_arc: str = "documentary_arc"  # Default for long-form
        ...
        """
        arc_template = EMOTIONAL_ARCS.get(target_arc, EMOTIONAL_ARCS["documentary_arc"])
...
def get_recommended_arc(content_type: str, duration: int = 360) -> Dict:
    """Get recommended emotional arc for content type"""
    analyzer = EmotionAnalyzer()
    return analyzer.suggest_emotional_arc(content_type, duration)

...
Key Features:
- 12 hook templates (question, challenge, promise, shock, story, etc.)
...
- Viral pattern matching (analyze top videos in niche)
...
# ============================================================================
# HOOK TYPES - 12 Templates
# ============================================================================

class HookType(Enum):
    """Hook template types for viral videos"""
...
class HookGenerator:
    ...
    Generates unique, viral hooks for YouTube videos with:
    ...
    def __init__(self, gemini_api_key: str, model: str = "gemini-2.5-flash-lite"):
        """
    ...
    def generate_hooks(
        ...
        num_variants: int = 3,
        max_words: int = 15  # Long-form can have slightly longer hooks
        ...
        Args:
            ...
            max_words: Maximum words in hook (default: 15 for long-form)
    ...
    def _detect_target_emotion(self, topic: str, content_type: str) -> EmotionType:
        ...
        if any(word in topic_lower for word in ["horror", "scary", "danger", "warning", "avoid"]):
            ...
            content_defaults = {
                ...
                "educational": EmotionType.CURIOSITY,
                ...
                "documentary": EmotionType.CURIOSITY,
                "storytelling": EmotionType.ANTICIPATION,
                "sports": EmotionType.ANTICIPATION,
                "vlog": EmotionType.JOY,
            }
    ...
    def _generate_hook_with_gemini(
        ...
        # Build prompt
        prompt = f"""Create a VIRAL YouTube video hook (first 5 seconds, max {max_words} words).
...
Requirements:
1. MAXIMUM {max_words} words (5 seconds speaking time)
...
4. NO meta-talk ("this video", "today we", "let me show", "in this video")
5. START with highest-impact word/phrase
6. Be SPECIFIC, not generic
7. Create curiosity gap - make them NEED to know more
8. Include number or specific detail if possible
9. Perfect for long-form educational/documentary content
...
Return ONLY the hook text, nothing else."""
    ...
    def _score_hook(self, variant: HookVariant, topic: str) -> float:
        ...
        Scoring factors:
        - Length (ideal: 10-15 words for long-form) - 20%
        - Power words - 30%
        - Specificity - 20%
        ...
        # 1. Length score (ideal: 10-15 words for long-form)

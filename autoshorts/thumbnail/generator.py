...
class ThumbnailGenerator:
    ...
    Optimized for long-form videos (3-10 minutes, 16:9 aspect ratio).
    """
    ...
    def generate(
        ...
        best_frames = self.face_detector.get_best_frames(
            ...
            diversity_threshold=0.2  # Lower for long-form (more diverse)
        )
        ...
        logger.info("Step 2: Generating text variations...")
    ...
    def _select_style_for_content(
        ...
        style_map = {
            ...
            "science": TextStyle.BOLD_OUTLINE,
            "history": TextStyle.SIMPLE_CLEAN,
            "nature": TextStyle.BOLD_OUTLINE,
            "documentary": TextStyle.SIMPLE_CLEAN,
        }

# FILE: autoshorts/video/downloader.py
# -*- coding: utf-8 -*-
"""Video downloader with validation (uses a session + larger chunks for speed)."""
import re
import os
import pathlib
import requests
...
class VideoDownloader:
    ...
    def __init__(self) -> None:
        ...
        self._session.headers.update({
            "User-Agent": "Mozilla/5.0 (compatible; AutoShortsBot/1.0)"
        })
    ...
    def download(
        ...
        for idx, (vid, link) in enumerate(pool):
            ...
            try:
                with self._session.get(link, stream=True, timeout=60) as r:
                    r.raise_for_status()
                    ...
                    with open(out_path, "wb") as f:
                        for chunk in r.iter_content(64 * 1024):  # 64KB chunks
                            if chunk:
                                f.write(chunk)

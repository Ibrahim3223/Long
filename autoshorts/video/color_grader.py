...
class LUTDefinition:
    ...
    # Best for
    best_for_moods: List[str] = field(default_factory=list)
    best_for_content: List[str] = field(default_factory=list)

    # Performance
    viral_score: float = 0.8        # 0-1 based on performance
    mobile_optimized: bool = True   # Optimized for mobile feeds
...
LUT_PRESETS = {
    LUTPreset.VIBRANT: LUTDefinition(
        ...
        name="Vibrant Pop",
        description="High saturation, punchy colors - stands out in feeds",
        contrast=0.3,
        brightness=0.1,
        saturation=0.5,
        highlights=0.2,
    ...
    LUTPreset.CINEMATIC: LUTDefinition(
        ...
        best_for_content=["tech", "documentary", "education", "educational", "news"],
        viral_score=0.82,
        mobile_optimized=True
    ),
    ...
    LUTPreset.DARK: LUTDefinition(
        ...
        best_for_content=["horror", "thriller", "mystery", "tech", "documentary"],
        viral_score=0.78,
    ...
    LUTPreset.WARM: LUTDefinition(
        ...
        best_for_content=["lifestyle", "food", "travel", "vlog", "storytelling"],
        viral_score=0.80,
        mobile_optimized=True
    ),
    ...
    LUTPreset.COOL: LUTDefinition(
        ...
        best_for_content=["tech", "science", "business", "education", "educational"],
        viral_score=0.79,
        mobile_optimized=True
    ),
    ...
    LUTPreset.VINTAGE: LUTDefinition(
        ...
        best_for_content=["music", "art", "history", "culture", "documentary"],
        viral_score=0.72,
        mobile_optimized=False
    ),
...
class ColorGrader:
    ...
    def get_ffmpeg_filter(
        ...
        # 4. Color tints (using colorbalance)

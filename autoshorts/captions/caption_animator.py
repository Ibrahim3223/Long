...
Key Features:
- 9 animation styles (pop, bounce, typewriter, slide, fade, zoom, wave, glitch, karaoke)
...
class StyleDefinition:
    ...
    best_for_emotion: List[str] = field(default_factory=list)

    # Performance
    viral_score: float = 0.8       # 0-1 effectiveness
...
ANIMATION_STYLES = {
    ...
    AnimationStyle.TYPEWRITER: StyleDefinition(
        ...
        name="Typewriter",
        description="Character-by-character reveal - great for long-form",
        ...
        outline_width=2.5,
        shadow_depth=1.5,
        best_for_content=["education", "educational", "storytelling", "documentary"],
    ...
    AnimationStyle.SLIDE: StyleDefinition(
        ...
        outline_width=3.0,
        shadow_depth=2.0,
        best_for_content=["tech", "news", "business", "documentary"],
    ...
    AnimationStyle.FADE: StyleDefinition(
        ...
        outline_width=2.0,
        shadow_depth=1.0,
        best_for_content=["lifestyle", "wellness", "beauty", "documentary"],
    ...
    AnimationStyle.KARAOKE: StyleDefinition(
        ...
        outline_width=3.0,
        shadow_depth=2.0,
        best_for_content=["music", "education", "educational", "documentary", "all"],
...
class CaptionAnimator:
    ...
    def identify_power_words(
        ...
        power_words = [
            ...
            "hidden", "discovered", "mystery", "ancient", "forbidden",
            "powerful", "dangerous", "fascinating", "extraordinary"
        ]
